import type { Sesion, TeamId, AccessoryType, PitchType } from '../types'

/* Training Phases */
export const FASES = ['Entrenamientos 1ª Fase','Entrenamientos 2ª Fase','Partidos Entrenamiento']

/* Exercise Types */
export const TIPOS_EJERCICIO = ['Técnico','Táctico','Físico','Rondo','Partido reducido','Calentamiento','Posesión','Pressing','Otro']
...
export const SESION_EMPTY: Sesion = {
  fecha:'',hora:'',campo:'',numConvocatoria:'',fase:'',entrenador:'',numJugadorasConvocadas:'',
  objetivos:'',observaciones:'',capturas:[],ejercicios:[]
}

export const EJ_SESION_EMPTY = {
  tipo:'', duracion:'', descripcion:'', numJugadores:'', material:'', imagen: null as string | null
}
